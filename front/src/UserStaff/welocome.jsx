...
export default function Welcome() {
    ...
    return (
        ...
        <div className="content">
          <div className="getc">
              <img id="image" style={{height:"300px"}} src={require("../components/img/pugmelogopng.png")} onclick="changeImage()"/>
              <h1 className="title"><b>Welcome to <img src={require("../components/img/pugmehorisontal.png")} width="120" style={{verticalAlign:"middle"}}/></b> </h1>
              <h2 className="morestaff">
                ...
                <div className="wrapper">
                    <a className="okok" href="join"><span>🤎Join Now!❤️</span></a>
                </div>
                <div>
